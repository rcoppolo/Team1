...
puts "Driving time: " + (drive_route.calc_drive_time / 60).round(2).to_s + " minutes"
puts "Driving cost: $" + (drive_route.calc_drive_cost / 100.0).round(2).to_s
puts "---"
puts "Computing Bart Route....."
puts "Bart time: " + (public_transportation_route.time_in_seconds / 60).round(2).to_s  + " minutes"
puts "Bart cost: " + "$" +(public_transportation_route.cost_in_pennies / 100).round(2).to_s
puts "Decision:"
